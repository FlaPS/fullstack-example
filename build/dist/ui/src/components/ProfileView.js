...
exports.default = (function (_a) {
    ...
    return React.createElement(Layout, null,
        React.createElement(UserHeader_1.default, { url: profile.url, age: profile.age, name: profile.name }),
        React.createElement(InputField_1.default, { label: 'Country', value: profile.city, onChange: function (city) {
                return onChange && onChange(tslib_1.__assign({}, profile, { city: city }));
            } }),
