...
var renderExample = ramda_1.map(function (key) { return react_1.default.createElement("div", null, react_1.default.createElement(fonts[key], {}, key)); });
var renderFonts = ramda_1.compose(renderExample, ramda_1.keys);
react_2.storiesOf('styles', module)
    .add('fonts', function () { return react_1.default.createElement(Wrapper, null, renderFonts(fonts)); });
