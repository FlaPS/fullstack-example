...
var metrics = function (prop, cssProp) { return function (props) { return props[prop] &&
    (cssProp || prop) + ': ' + (isNaN(props[prop])
        ? props[prop]
        : props[prop] + 'px') + ';'; }; };
var getMarginAuto = function (props) { return props.marginAuto
    ? 'margin: auto;'
    : ''; };
var widthMetric = function (props) { return props.stretch
    ? 'width: 100%;'
    : metrics('width')(props); };
