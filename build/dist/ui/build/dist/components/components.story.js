...
react_2.storiesOf('components', module)
    .add('Avatar', function () { return react_1.default.createElement(Avatar_1.default, { url: userMock.url }); })
    .add('UserCard', function () { return react_1.default.createElement(UserCard_1.default, Object.assign({}, userMock)); })
    .add('UserList', function () { return UsersList_1.default(userListMock); })
    ...
    .add('Profile view', function () { return react_1.default.createElement(ProfileView_1.default, { profile: profileMock, onChange: log }); });
